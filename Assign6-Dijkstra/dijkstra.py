...
def findShortestPath(adj_list, source):
	# heap = [[value, key], ....]
	...
	heap, heap_dict, min_dist_dict = initializa_data_structures(adj_list, source)
...
def initializa_data_structures(adj_list, source):
	heap = []
...
#testing --- testing
adj_list = create_adj_list('graph.txt')

test = {1: [[2,1],[3,2]], 2: [[4,5]], 3: [[4,3]], 4: []}

findShortestPath(adj_list, 1)